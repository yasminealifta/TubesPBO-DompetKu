...
<%@ page import="com.dompetku.model.Kategori" %>
...
<body>
        ...
        <div class="main-form">
            ...
            <form action="transaksi" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis" id="jenisTransaksi" class="form-select">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="jumlah" id="jumlah" class="form-control" 
                                       placeholder="Masukkan jumlah transaksi" required />
                            </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="4" class="form-control" 
                                          placeholder="Tambahkan catatan untuk transaksi ini (opsional)"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="button-group">
                    ...
                    <a href="transaksi" class="btn-secondary-custom">
    ...
    <script>
        ...
        // AJAX untuk kategori (logika asli dipertahankan)
        document.getElementById("jenisTransaksi").addEventListener("change", function () {
            const jenis = this.value;
            const kategoriSelect = document.getElementById("kategori");

            fetch("transaksi?ajax=kategori&jenis=" + jenis)
